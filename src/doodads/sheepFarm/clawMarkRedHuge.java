...
public class clawMarkRedHuge extends chunk {
	...
	// Default name.
	private static String DEFAULT_CHUNK_NAME = "clawMarkRedHuge";
	
	// Sprite stuff.
	private static String DEFAULT_CHUNK_SPRITESHEET = "images/units/bosses/wolfless/"+ DEFAULT_CHUNK_NAME + ".png";
	
	// Dimensions
	public static int DEFAULT_CHUNK_WIDTH = 48;
	public static int DEFAULT_CHUNK_HEIGHT = 48;
	...
	///////////////
	// Constructor
	public clawMarkRedHuge(int newX, int newY, int i) {
