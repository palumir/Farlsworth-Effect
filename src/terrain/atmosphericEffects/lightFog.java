...
public class lightFog extends atmosphericEffect {
	
	// All fog effects in place.
	public static ArrayList<lightFog> allFog;
	...
	public void drawObject(Graphics g) {
		if(this == getMaxFog()) {
			...
			Color black = new Color(236f/255f, 244f/255f, 144f/255f, alpha); //Black 
	...
	// Get max fog
	public lightFog getMaxFog() {
		lightFog maxFog = null;
