...
public class flowerFarmCinematic extends cinematic {
	...
	public void updateCinematic() {
		...
		if(isSequence(numIfs++) && goNextTextSeries()) {
			...
			// Move right.
			addTextSeries("'A disruption?'", null,farlsworth, "Order");
			addTextSeries("Say nothing", null,farlsworth,"Chaos");
		...
		if(goNextTextSeries() && choiceIs("'A disruption?'")) {
			
			if(isSequence(numIfs++) && goNextTextSeries()) {
				
				// Set the next text and advance it.
				addTextSeries(null, "Yeah, a Disruption.", farlsworth);
			...
			if(isSequence(numIfs++) && goNextTextSeries()) {
				...
				// Set the next text and advance it.
				addTextSeries(null, "They are supernatural glitches that contort the world.", farlsworth);
				advanceSequence();
			}
			...
			if(isSequence(numIfs++) && goNextTextSeries()) {
				...
				// Set the next text and advance it.
				addTextSeries(null, "Things kind of just change suddenly... or disappear.", farlsworth);
				advanceSequence();
			}
			...
			if(isSequence(numIfs++) && goNextTextSeries()) {
				...
				// Set the next text and advance it.
				addTextSeries(null, "I hope a Disruption makes Farmer disappear.", farlsworth);
				advanceSequence();
			}
		...
		if(goNextTextSeries() && choiceIs("Say nothing")) {
