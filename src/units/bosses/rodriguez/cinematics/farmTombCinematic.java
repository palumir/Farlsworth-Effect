...
public class farmTombCinematic extends cinematic {
	...
	public void updateCinematic() {
		...
		if(isSequence(numIfs++) && goNextTextSeries()) {
			...
			// Set the next text and advance it.
			addTextSeries(null, "And we are limited on time, so I will cut straight to the chase.",rodriguez);
			advanceSequence();
		}
		...
		if(isSequence(numIfs++) && goNextTextSeries()) {
			...
			// Set the next text and advance it.
			addTextSeries(null, "And I will help you explore it.",rodriguez);
			advanceSequence();
		}
		...
		if(isSequence(numIfs++) && goNextTextSeries()) {
			...
			// Set the next text and advance it.
			addTextSeries(null, "But first, I need to know if you are strong enough.",rodriguez);
			advanceSequence();
		}
		...
		if(isSequence(numIfs++) && goNextTextSeries()) {
			...
			// Set the next text and advance it.
			addTextSeries(null, "And what would you know about strength, Rodriguez?",fernando);
			// Move right.
		...
		if(isSequence(numIfs++) && goNextTextSeries()) {
			...
			// Set the next text and advance it.
			addTextSeries(null, "You're getting quicker, Fernando.",rodriguez);
		...
		if(goNextTextSeries() && choiceIs("Do nothing")) {
			...
			if(isSequence(numIfs++) && goNextTextSeries()) {
				...
				addTextSeries(null, "You want to remove from humanity the very thing that makes us ...",fernando);
			...
			if(isSequence(numIfs++) && goNextTextSeries()) {
				...
				addTextSeries(null, "... human.",fernando);
			...
			if(isSequence(numIfs++) && goNextTextSeries()) {
				...
				addTextSeries(null, "I am right.",rodriguez);
				player.getPlayer().setFacingDirection("Right");
				// Set the next text and advance it.
				advanceSequence();
			}
